...
<body>
    ...
    <section class="msgsubmit">
        <div class="submit-container">
            <img src="./images/logoblack.png" alt="Logo Prapé" width="300">
            <h1>
                MENSAGEM ENVIADA COM SUCESSO
            </h1>
            <p>
                Obrigado! Em breve nossa equipe irá entrar<br>
                em contato com você através das informações enviadas.
            </p>
        </div>
    </section>
